            ...
            <nav className="bg-gray-800">
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="/" className="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">My Shop</a>
                        </div>
                        </div>
                    </div>
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div>
                            ...
                            <img className="h-8 w-8 rounded-full" src="profile.png" alt="profile picture"/>
                            </button>
                        </div>
                ...
                <div className={`lg:hidden ${menuOpen ? 'block' : 'hidden'}`} id="mobile-menu">
                    <div className="space-y-1 px-2 pb-3 pt-2">
                        ...
                        <a href="/policy" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Policy</a>
                        <a href="/" className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">My Shop</a>
                    </div>
                </div>
            </nav>
            {/* <div>
